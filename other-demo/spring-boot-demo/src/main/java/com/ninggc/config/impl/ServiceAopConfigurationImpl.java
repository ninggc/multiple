 ...
 */
@Component
public class ServiceAopConfigurationImpl implements AopConfiguration {
    ...
    public void before(JoinPoint joinPoint) {
        ...
        String logContent = "before service execute: " + classAndMethodName + "\t" +
    ...
    public Object afterReturn(JoinPoint joinPoint, Object returnValue) {
        ...
        String logContent = "after service execute: " + classAndMethodName + "\t"
