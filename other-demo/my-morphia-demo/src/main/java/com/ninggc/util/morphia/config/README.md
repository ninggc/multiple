...
```
  ...
  <!-- 使用工厂创建mongo实例 -->
  <bean id="mongo" class="com.wondersgroup.bigdata.project.MongoFactoryBean">
    <!-- mongoDB的配置对象 -->
...
<!--   使用工厂创建morphia实例，同时完成类映射操作-->
  <bean id="morphia" class="com.wondersgroup.bigdata.project.MorphiaFactoryBean" >
    <!-- 指定要扫描的POJO包路径 -->
...
<!--  <bean id="datastore_not_use" class="com.wondersgroup.bigdata.project.DatastoreFactoryBean" >-->
