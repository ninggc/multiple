package com.ninggc.common.util;
...
//    }
    ...
    public void startService(String msg) {
        logger.info(clazz.getSimpleName() + " mongodb 开始:  " + msg);
    }

    public void endService(String msg) {
        logger.info(clazz.getSimpleName() + " mongodb 结束:  " + msg);
    }

    public void startMysqlService(String msg) {
        logger.info(clazz.getSimpleName() + " mysql 开始:  " + msg);
    }

    public void endMysqlService(String msg) {
        logger.info(clazz.getSimpleName() + " mysql 结束:  " + msg);
    }

    public void startHttpClient(String msg) {
        logger.info(clazz.getSimpleName() + " http 开始:  " + msg);
    }

    public void endHttpClient(String msg) {
        logger.info(clazz.getSimpleName() + " http 结束:  " + msg);
    }
}
